...
static LedWorkFreq arryLedFreq[] = {
    {LedWorkState_NetSetting,       {4, 50     }   },
    {LedWorkState_NetConnectOk,     {1, 0    }   },
    {LedWorkState_NetDisconnect,    {1, 30     }   },

    {LedWorkState_SysBufLow,        {3, 70     }   },
    {LedWorkState_SysPause,         {1, 30     }   },
...
LedPwmPara arryLedPara[] = {
	{0xFF,          0xFF,           0xFF,                0xFF},
    {PwmChannel1,   LEDC_TIMER_1,   LED_INDICATOR_NET,   0xFF},
    {0xFF,          0xFF,           0xFF,                0xFF},
};
...
void UserGpioInit()
{
    ...
    io_conf.pin_bit_mask     = GPIO_SEL_LED;
    io_conf.mode             = GPIO_MODE_OUTPUT;
    io_conf.pull_up_en       = GPIO_PULLUP_ENABLE;
    io_conf.intr_type        = GPIO_PIN_INTR_DISABLE ;
    gpio_config(&io_conf);
    ESP_LOGI(LED_TAG, "LED net=%d", LED_INDICATOR_NET);
    gpio_set_level(LED_INDICATOR_NET, 0x00);
#endif
